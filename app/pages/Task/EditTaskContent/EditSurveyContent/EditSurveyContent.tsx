...
import Styles from "./EditSurveyContent.module.css"
...
const RenderAnswerForm: React.FC<{
    ...
    return (
        <div className={Styles.answer}>
            ...
            <Input label="" name={getAnswerInputName("content")} type="text" />
        </div>
    )
}
    ...
    return (
        <details className={Styles.quest}>
            <summary className={Styles.toggleContent}>
                <span>Frage: {quest.question}</span>
...
const RenderContentForm: React.FC<{
    ...
    return (
        <details className={Styles.content} open={index === 0}>
            ...
            <div className={Styles.contentMain}>
                <span className={Styles.heading}>Umfrage-Informationen</span>
                <Input label="" name={`contents[${index}].id`} type="hidden" />
                <Input label="Titel" name={getInputName("title")} type="text" />
                <Input
                    label="Beschreibung"
...
const EditSurveyContent: EditTaskContentView = () => {
...
export default EditSurveyContent

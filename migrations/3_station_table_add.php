...
class StationTableAdd extends Migration
{
    public function up()
    {
        ...
        // $db->exec("ALTER TABLE `studip`.`yuoshi_tasks` DROP COLUMN package_id, DROP FOREIGN KEY yuoshi_tasks_ibfk_1, ADD FOREIGN KEY (`station_id`) REFERENCES `yuoshi_stations` (`id`)");
        // $db->exec("ALTER TABLE `studip`.`yuoshi_tasks` ADD COLUMN station_id varchar(32) NOT NULL");
        ...
        // $db->exec("ALTER TABLE `studip`.`yuoshi_tasks` DROP COLUMN package_id, ADD FOREIGN KEY (`station_id`) REFERENCES `yuoshi_stations` (`id`)");
    }
